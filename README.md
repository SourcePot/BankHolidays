...
Depending on the country a goverment internet resource is used (such as *Gov.uk*) or dates are derived from rules without the use of an internet resource (such as for Germamny).
